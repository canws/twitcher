...
<strong><?php echo e(__('Streamer Categories')); ?></strong>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('section_body'); ?>

<form method="POST" action="<?php echo e(empty($catname) ? '/admin/add_category' : '/admin/update_category'); ?>">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input','data' => ['type' => 'text','name' => 'catname','value' => ''.e($catname).'','placeholder' => ''.e(__('Category Name')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['type' => 'text','name' => 'catname','value' => ''.e($catname).'','placeholder' => ''.e(__('Category Name')).'']); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?><?php echo e(__('Category')); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?><?php echo e(__('Users')); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                 <?php $__env->slot('field', null, []); ?> <?php echo e(__('Category')); ?> <?php $__env->endSlot(); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                 <?php $__env->slot('field', null, []); ?> <?php echo e(__('Users')); ?> <?php $__env->endSlot(); ?>
                <span class="inline-flex px-2 py-1 bg-indigo-200 text-indigo-700 rounded-lg">
                    <?php echo e($c->users_count); ?>
...
<?php $component->withAttributes([]); ?>
                ...
                <div class="btn-group">
                    <a class="inline-flex mr-2" href="/admin/categories?update=<?php echo e($c->id); ?>">
                        <i class="fa-solid fa-pencil text-teal-600"></i>
                    </a>
                    <a href="/admin/categories?remove=<?php echo e($c->id); ?>"
                        onclick="return confirm('<?php echo e(__('Are you sure you want to remove this category from database?')); ?>');"
                        class="inline-flex">
...
<?php else: ?>
<?php echo e(__('No categories in database.')); ?>

<?php endif; ?>

<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\canws\twitcher\love248\resources\views/admin/categories.blade.php ENDPATH**/ ?>
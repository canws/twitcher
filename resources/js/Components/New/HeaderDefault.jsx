import { Button, Nav, Navbar, Offcanvas, Container, Dropdown } from "react-bootstrap";
import { BiSolidVideos, BiCog, BiBell } from "react-icons/bi";
                    ...
                    <Container fluid className="navbar-inner">
                        <div className="d-flex align-items-center justify-content-between w-100 landing-header">
                                    ...
                                    >
                                        <Nav.Item as="li">
                                            <Nav.Link
                                                as={Link}
                                                href={route("home")}
                                                className={`${location.pathname === "/" || location.pathname === "/home"
                                                    ? "active" : ""}`}
                                            >
                                        ...
                                        <Nav.Item as="li">
                                            <Nav.Link
                                                ...
                                                className={`${location.pathname === "/browse-channels" ? "active" : ''}`}
                                            >
                                        ...
                                        <Nav.Item as="li">
                                            <Nav.Link
                                                ...
                                                className={`${location.pathname === "/browse-videos" ? "active" : ""}`}
                                            >
                                        ...
                                        <Nav.Item as="li">
                                            <Nav.Link
                                                ...
                                                className={`${location.pathname === "/browse-gallery" ? "active" : ""}`}
                                            >
                                        ...
                                        <Nav.Item as="li">
                                            <Nav.Link
                                                ...
                                                className={`${location.pathname === "/get-tokens" ? "active" : ""}`}
                                            >
                                        ...
                                        <Nav.Item as="li">
                                            <Nav.Link
                                                ...
                                                className={`${location.pathname === "/get-subscriptions" ? "active" : ""}`}
                                                >
                            ...
                            <div className="right-panel">
                                ...
                                <div
                                    className={`navbar-collapse ${show === true ? "collapse" : "show"
                                        }`}

...
const FooterMega = memo(() => {
    ...
    return (
        <>
            <Fragment>
                <footer className="footer footer-default" style={{ background: '#141314' }}>
                    <Container fluid>
                        <div className="footer-top">
                            <Row>
                                ...
                                {/* <Col xl={2} lg={6} className="mb-5 mb-lg-0">
                                    <h4 className="footer-link-title text-white">Movies to watch</h4>
                                    <ul className="list-unstyled footer-menu">
                                        <li className="mb-3">
                                ...
                                <Col xl={3} lg={6} className="mb-5 mb-lg-0">
                                    <h4 className="footer-link-title text-white">About company</h4>
                                    <ul className="list-unstyled footer-menu">
                                        {pages.map((p) => (
                                            <li className="mb-3">
                                                <Link className="ms-3" key={`page-${p.id}`} href={route("page", { page: p.page_slug })}> {p.page_title} </Link>
                                            </li>
                                ...
                                <Col xl={3} lg={6}>
                                    <h4 className="footer-link-title text-white">Subscribe Newsletter</h4>
                                    ...
                                    <div className="d-flex align-items-center mt-5">
                                        <span className="font-size-14 me-2 text-white">Follow Us:</span>
                                    ...
                                    <ul className="menu list-inline p-0 d-flex flex-wrap align-items-center justify-content-center">
                                        {pages.map((p) => (
                                            <li className="menu-item">
                                                <Link key={`page-${p.id}`} href={route("page", { page: p.page_slug })}> {p.page_title} </Link>
                                            </li>

                                        ))}
                                        <li className="menu-item">
                                            <Link href={route("contact.form")}> {__("Get in Touch")}  </Link>
                                        </li>
                                    </ul>

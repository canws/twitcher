        ...
        <>
            <div className={`dark:text-zinc-200 mt-5`}>
                ...
                {tiers.map((tier) => (
                    <div
                        key={`tier-${tier.id}`}
                        className={`flex flex-col md:items-center md:flex-row md:space-x-10 border-b py-5 bg-white dark:bg-zinc-900 dark:border-b-zinc-800 rounded-lg shadow-sm mb-5 px-5  ${tier.id === tierSubscribed &&

<div class="
    ...
    <div class="overflow-y-auto overflow-x-hidden flex flex-col justify-between flex-grow">
        <ul class="flex flex-col py-4 space-y-1">
            ...
            <li>
                <a href="/admin/commission-list" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-600 text-white-600 hover:text-white-800 border-l-4 border-transparent hover:border-gray-800 pr-6">
                    <span class="inline-flex justify-center items-center ml-4">
                        <i class="fa-solid fa-user-check"></i>
                    </span>
                    <span class="ml-2 text-sm tracking-wide truncate">{{ __('Commission') }}</span></a>
            </li>
            <li>
            ...
            <li>
                <a href="/admin/streamer-earning" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-600 text-white-600 hover:text-white-800 border-l-4 border-transparent hover:border-gray-800 pr-6">
                    <span class="inline-flex justify-center items-center ml-4">
                        <i class="fa-solid fa-money-bill"></i>
                    </span>
                    <span class="ml-2 text-sm tracking-wide truncate">{{ __('Stream Earning') }}</span></a>
            </li>
            <li>
                <a href="/admin/videos-sales" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-600 text-white-600 hover:text-white-800 border-l-4 border-transparent hover:border-gray-800 pr-6">
                    <span class="inline-flex justify-center items-center ml-4">
                        <i class="fa-solid fa-money-bill"></i>
                    </span>
                    <span class="ml-2 text-sm tracking-wide truncate">{{ __('Videos Sales') }}</span></a>
            </li>
            <li>
                <a href="/admin/gallery-sales" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-600 text-white-600 hover:text-white-800 border-l-4 border-transparent hover:border-gray-800 pr-6">
                    <span class="inline-flex justify-center items-center ml-4">
                        <i class="fa-solid fa-money-bill"></i>
                    </span>
                    <span class="ml-2 text-sm tracking-wide truncate">{{ __('Gallery Sales') }}</span></a>
            </li>
            <li>
                <a href="{{route('admin.tag-pixels.index')}}" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-600 text-white-600 hover:text-white-800 border-l-4 border-transparent hover:border-gray-800 pr-6">
                    <span class="inline-flex justify-center items-center ml-4">
                        <i class="fa-solid fa-code"></i>
                    </span>
                    <span class="ml-2 text-sm tracking-wide truncate">{{ __('TAG PIXELS ADS') }}</span></a>
            </li>
            <li>
